...
\clearscrheadfoot
	\ihead{\normalfont\footnotesize \texttt{bib}\LaTeX-style \texttt{nottsclassic 0.1} (c) by Lukas C. Bossert | William Leveritt}%
...
%\CodelineIndex
%\RecordChanges
\addbibresource{nottsclassic.bib}
...
\lstset{style=bibentry}
%\lstMakeShortInline[style=bibentry]{|}


\usepackage{hyperxmp}
%\usepackage{hyperref}
\hypersetup{					% setup the hyperref-package options
	pdftitle={bib\LaTeX-nottsclassic},	% 	- title (PDF meta)
	pdfsubject={},% 	- subject (PDF meta)
	pdfauthor={Lukas C. Bossert, William Leveritt},	% 	- author (PDF meta)
	pdfauthortitle={},
...
of this license or (at your option) any later version.},
	...
	pdfkeywords={biblatex, humanities, humanities},
%	pdfproducer={XeLaTeX},
